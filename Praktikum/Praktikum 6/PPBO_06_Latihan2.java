...
public class PPBO_06_Latihan2 {
    public static void main(String[] args) {
        ...
        for(Mahasiswa mhs : mahasiswaArr)
            hashMapMhs.put(mhs.NIM, mhs);

        for (Map.Entry<String, Mahasiswa> mhs : hashMapMhs.entrySet())
            System.out.println(String.format("key: %s => data mahasiswa: %s, %s, %s", mhs.getKey(), mhs.getValue().nama, mhs.getValue().NIM, mhs.getValue().angkatan));
    }
}
