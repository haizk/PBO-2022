...
interface IInfusable {
    abstract public void infuse(String element);
}
...
class Sword extends Weapon implements IInfusable{
    ...
    public void specialMove() {
        System.out.println("Player performs a Forward Thrust with their " + this.getClass().getSimpleName() + "!");
    }
    @Override
...
class Axe extends Weapon implements IInfusable{
    ...
    @Override
    public void specialMove() {
        System.out.println("Player performs a Jump Charge with their " + this.getClass().getSimpleName() + "!");
    }
    @Override
    public void infuse(String element) {
...
class Consumable extends Item {
    ...
    public void consume() {
        System.out.println("Player consumes " + this.name + " and restored " + recoveredHealthPoint + " HealthPoint");
    }
}
